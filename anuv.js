...
music=new Audio('audio/anuv jain/1.mp3');
// music.play();
...
const song=[
    ...
    },
    {
        ...
        poster:"img/anuv jain/1.jfif"
    }, {
        id:12,
        songName:`Putt Jatt Da 
        <br>
        <div class="subtitle">Putt Jatt Da </div>`,
        poster:"img/anuv jain/2.jfif"
    }, {
        id:13,
        songName:`Baarishein
        <br>
        <div class="subtitle">Atif Aslam</div>`,
        poster:"img/anuv jain/3.png"
    }, {
        id:14,
        songName:`Vaaste
        <br>
        <div class="subtitle">Dhvani Bhanushali</div>`,
        poster:"img/anuv jain/4.jfif"
    },
    {
        id:15,
        songName:`Lut Gate
        ...
        poster:"img/anuv jain/5.jfif"
    }, {
        id:16,
        songName:`Tu meri Jindgi Hai 
        <br>
        <div class="subtitle">Jubin Nautiyal</div>`,
        poster:"img/anuv jain/6.png"
    },
]
...
Array.from(document.getElementsByClassName('playlisplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        ...
        musicPlay.classList.remove('bi-play-fill');
        musicPlay.classList.add('bi-pause-fill');
        poster.src=`img/anuv jain/${index}.jpg`;
        download.href=`audio/anuv jain/${index}.mp3`;
...
back.addEventListener('click',()=>{
    ...
    music.src=`audio/anuv jain/${index}.mp3`;
    music.play();
    musicPlay.classList.remove('bi-play-fill');
    musicPlay.classList.add('bi-pause-fill');
    poster.src=`img/anuv jain/${index}.jpg`;
